...
export default function FilterSection() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed inset-y-0 inset-s-0 z-50 h-screen w-64 space-y-6 bg-neutral-100 p-6 shadow-2xl transition-transform duration-300 ease-in-out md:relative md:h-auto md:w-60 md:translate-x-0 md:rounded-xl md:border md:border-neutral-200 md:bg-transparent md:shadow-none shrink-0',
