...
export const useAddToCart = () =>
  useCartMutation(cartService.addItem)

export const useApplyCoupon = () =>
  useCartMutation(cartService.applyCoupon)

export const useUpdateCartItem = () =>
  useCartMutation(cartService.updateItem)

export const useRemoveCartItem = () =>
  useCartMutation(cartService.removeItem)

export const useClearCart = () =>
  useCartMutation(cartService.clear)

export const useRemoveCoupon = () =>
  useCartMutation(cartService.removeCoupon)
