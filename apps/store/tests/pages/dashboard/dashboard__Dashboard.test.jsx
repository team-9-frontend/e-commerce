...
vi.mock('@/components/stats/DashboardStats', () => ({
  default: () => <div>DashboardStats-mock</div>,
}))
vi.mock('@/components/stats/OrderStatus', () => ({
  default: () => <div>OrderStatus-mock</div>,
}))
vi.mock('@/components/stats/RecentOrders', () => ({
  default: () => <div>RecentOrders-mock</div>,
}))
vi.mock('@/components/stats/StatsSkeleton', () => ({
  default: () => <div>StatsSkeleton-mock</div>,
}))
vi.mock('@/components/stats/TopProducts', () => ({
