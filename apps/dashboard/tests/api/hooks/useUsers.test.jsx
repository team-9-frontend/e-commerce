...
import { useAddUser, useDeleteUser, useGetAllUsers, useGetUserById, useUpdateUser } from '@repo/api'
import { userKeys } from '@repo/api//keys/userKeys'
import { usersService } from '@repo/api/services/usersService'

vi.mock('@repo/api/services/usersService', () => ({
  usersService: {
    getAll: vi.fn(),
    getById: vi.fn(),
    add: vi.fn(),
