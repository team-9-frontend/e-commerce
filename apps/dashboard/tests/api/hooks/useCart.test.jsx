...
import { cartService } from '@repo/api/services/cartService'

vi.mock('@repo/api/services/cartService', () => ({
  cartService: {
    getCart: vi.fn(),
    addItem: vi.fn(),
    applyCoupon: vi.fn(),
...
describe('useCart hooks', () => {
  ...
  it.each([
    ...
    '%s calls the matching service function and invalidates the cart',
